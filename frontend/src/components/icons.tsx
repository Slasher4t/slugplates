// Small hand-picked set of outline icons in an SF-Symbols-ish style (thin
// stroke, rounded caps) - no icon package dependency for a handful of glyphs.
...
export function MenuIcon({ className }: IconProps) {
  return (
    <svg {...base} className={className}>
      <path d="M4 19V6a2 2 0 0 1 2-2h5l2 2h5a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2z" />
    </svg>
  );
}
